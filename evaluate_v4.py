...
def main():
    ...
    print("=== V4 Model Evaluation (Held-out Test Split) ===")
    ...
    print(
        f"Shoplifting | Precision: {precision[1]:.3f}  Recall: {recall[1]:.3f}  F1: {f1[1]:.3f}"
    )

    report_path = os.path.join(DATA_DIR, "evaluation_v4_confusion_matrix.txt")
    with open(report_path, "w", encoding="utf-8") as f:
        f.write("=== V4 Model Evaluation (Held-out Test Split) ===\n")
