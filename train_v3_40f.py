...
if __name__ == "__main__":
    ...
    joblib.dump(scaler, os.path.join(DATA_DIR, "scaler_v3_40f.pkl"))
    ...
    print("\nStarting Clean V3 (BiLSTM) Training on 40 Frames...")
    ...
    for epoch in range(150):
        ...
        if acc > best_acc:
            best_acc = acc
            patience_counter = 0
            torch.save(model.state_dict(), os.path.join(DATA_DIR, "best_v3_40f.pth"))
        else:
            patience_counter += 1
    ...
    print(f"\nTraining Complete. Validated Best Accuracy (BiLSTM 40f): {best_acc:.2f}%")