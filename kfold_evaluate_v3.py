...
class PoseBiLSTM(nn.Module):
    def __init__(self):
        ...
        self.relu = nn.ReLU()
        self.lstm = nn.LSTM(128, self.hidden_size, num_layers=self.num_layers, batch_first=True, bidirectional=True)
...
if __name__ == "__main__":
    ...
    for fold, (train_idx, test_idx) in enumerate(skf.split(X, y), 1):
        ...
        # 6. Train the fold
        for epoch in range(100): # Capped at 100 for speed during K-fold
            model.train()
